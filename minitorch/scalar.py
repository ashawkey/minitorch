...
class ScalarFunction(FunctionBase):
    ...
    # Checks.
    variable = Scalar # kiui: use this to wrap the output of apply
    data_type = float # kiui: expected return type of forward

    # kiui: called before cls.variable, extract raw data from forward output?
    @staticmethod
    def data(a):
        return a
